...
/**
 * look-fly-controls - look-controls plus z-axis, as needed by flying apps.
 * Update entity pose, factoring mouse, touch, and WebVR API data.
 */
registerComponent('look-fly-controls', {
    ...
    init: function () {
        console.log("look-fly-controls init");
